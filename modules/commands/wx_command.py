...
class WxCommand(BaseCommand):
    ...
    examples = ["wx Example City", "wx Example City tomorrow", "wx Example City 7d"]
    parameters = [
    ...
    def __init__(self, bot):
        ...
        if WX_INTERNATIONAL_AVAILABLE:
            ...
            self.delegate_command.description = "Get weather information for any location (usage: wx Example City)"
            self.logger.info(
    ...
    def _count_display_width(self, text: str) -> int:
        """Estimate safe transport width, accounting for emojis and UTF-8 bytes."""
        width = len(text)
